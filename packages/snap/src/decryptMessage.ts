...
import { Wallet, EncryptMessageResponse } from '@astrox/schnorr-snap-types';

export async function decryptMessage(wallet: Wallet, theirPublicKey: string, cipherText: string): Promise<EncryptMessageResponse> {
